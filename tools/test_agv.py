...
실행:
    ...
    python tools/test_agv.py --cmd TRAY_LOADED     # 출발
...
def main():
    ...
    # 대화형 대기 모드
    print("\n대기 중 — AGV 상태 수신 시 출력")
    print("키: 1/2=STATUS  g=GO_W1  h=GO_W2  t=TRAY_LOADED  m=CLEAR_MISSION")
    print("    7/8/9=GO_HOME_1/2/3  e=E-STOP  c=CLEAR  q=종료\n")
    try:
        ...
        while True:
            if msvcrt.kbhit():
                ...
                if k == "q":
                    ...
                    send(client, args.id, "TRAY_LOADED")
                elif k == "m":
